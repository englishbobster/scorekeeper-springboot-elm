...
var author$project$ScoreKeeper$PopulateInitialMatches = function (a) {
	return {$: 'PopulateInitialMatches', a: a};
};
var author$project$ScoreKeeper$Match = F6(
	function (id, homeTeam, awayTeam, matchTime, arena, group) {
		return {arena: arena, awayTeam: awayTeam, group: group, homeTeam: homeTeam, id: id, matchTime: matchTime};
	});
...
var author$project$ScoreKeeper$matchDecoder = A7(
	elm$json$Json$Decode$map6,
	author$project$ScoreKeeper$Match,
	A2(elm$json$Json$Decode$field, 'matchid', elm$json$Json$Decode$int),
	A2(elm$json$Json$Decode$field, 'homeTeam', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'awayTeam', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'matchTime', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'arena', elm$json$Json$Decode$string),
	A2(elm$json$Json$Decode$field, 'group', elm$json$Json$Decode$string));
var elm$json$Json$Decode$list = _Json_decodeList;
var author$project$ScoreKeeper$matchListDecoder = A2(
	elm$json$Json$Decode$field,
	'tournamentMatches',
	elm$json$Json$Decode$list(author$project$ScoreKeeper$matchDecoder));
var author$project$ScoreKeeper$toAdminApiUrl = 'http://127.0.0.1:8080/admin/planned-matches';
...
var author$project$ScoreKeeper$getTournamentMatchesRequest = A2(elm$http$Http$get, author$project$ScoreKeeper$toAdminApiUrl, author$project$ScoreKeeper$matchListDecoder);
...
var author$project$ScoreKeeper$getTournamentMatches = A2(elm$http$Http$send, author$project$ScoreKeeper$PopulateInitialMatches, author$project$ScoreKeeper$getTournamentMatchesRequest);
var author$project$ScoreKeeper$initialModel = _List_Nil;
var author$project$ScoreKeeper$init = function (_n0) {
	return _Utils_Tuple2(author$project$ScoreKeeper$initialModel, author$project$ScoreKeeper$getTournamentMatches);
};
