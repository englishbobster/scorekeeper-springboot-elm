...
public class FinalScoreTest {
    ...
    public void scores_are_equal() {
        FinalScore finalScore1 = new FinalScore(1,1, 1);
        FinalScore finalScore2 = new FinalScore(1,1, 1);
    ...
    public void scores_are_not_equal() throws Exception {
        FinalScore finalScore1 = new FinalScore(1,1, 1);
        FinalScore finalScore2 = new FinalScore(1,1, 3);
    ...
    public void toString_is_printed_correctly() throws Exception {
        FinalScore finalScore1 = new FinalScore(1,1, 7);
